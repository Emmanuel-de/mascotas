            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="GET" action="{{ route('pets.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <!-- Breed Filter -->
                        <div>
                            <label for="breed" class="block text-sm font-medium text-gray-700">🏷️ Criar</label>
                                    ...
                                    @foreach($pets as $pet)
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                                <a href="{{ route('pets.show', $pet) }}" class="text-blue-600 hover:text-blue-900">👁️ Ver</a>
                                                <a href="{{ route('pets.edit', $pet) }}" class="text-indigo-600 hover:text-indigo-900">✏️ Editar</a>
